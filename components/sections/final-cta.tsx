      ...
      <div className="relative container-wide py-20 sm:py-24 md:py-32 lg:py-36">
        <div className="max-w-lg mx-auto text-center mb-12">
          ...
          <Reveal delay={0.1}>
            ...
            >
              We're opening iClose to a select group before public launch. Members who join now lock in founding terms — and get first access to the deal desk when we go live.
            </p>
          </Reveal>
        </div>
        ...
        >
          <div className="bg-white rounded-apple p-6 sm:p-8 md:p-10 shadow-elevated">
            ...
            <p className="mt-5 text-center text-[13px] text-graphite tracking-tight">
              No spam. You join as a Member on the Plus plan — free, no card required.
            </p>
          </div>
        </motion.div>
      </div>
