...
export function NotificationBar() {
  ...
  return (
    <Link href="/credits" className="block bg-[#e11d48] hover:bg-[#c81840] transition-colors">
      <div className="container-wide py-3 sm:py-3.5 flex items-center justify-center gap-1.5 text-center text-[13px] sm:text-[14px] text-white">
        ...
        <span className="text-white underline underline-offset-2 inline-flex items-center gap-0.5 font-semibold whitespace-nowrap">
