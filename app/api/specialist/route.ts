...
export async function POST(request: Request) {
  try {
    ...
    // Insert into educators — verification_token auto-generated by DB default
    ...
    try {
      ...
      if (error) console.error('[specialist] DB insert failed:', error);
    } catch (err) {
    ...
    const verifyUrl = verificationToken
      ? `${origin}/api/verify?token=${verificationToken}&type=educator`
      : null;
